...
function setBackgroundBoxes()  -- Set transparent black boxes
 ...
 elseif mode[index] == "Roamer" then
  gui.box(1, -191, 156, -81, "#0000007F", "#0000007F")
 end
...
function showCGearSeedInfo(delay)
 if showCGearSeedInfoText then
  ...
  gui.text(2, 13, string.format("Next Initial Seed: %08X", buildSeedFromDelay(delay + 308, true)))
  gui.text(2, 24, string.format("Next Delay: %d", delay + 308))
  gui.text(2, 35, string.format("Delay: %d", delay))
  gui.text(2, 46, string.format("C-Gear Seed: %08X", cgearSeed))
  gui.text(2, 57, string.format("Hit Delay: %d", hitDelay))
  gui.text(2, 68, string.format("Hit Date/Hour:\n%s", hitDate))
 end
end
